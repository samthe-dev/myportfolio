      ...
      >
        <div className="w-full max-w-4xl mx-auto flex items-center justify-between px-6 py-4">
          ...
          <button
            ...
            className="relative flex flex-col items-center justify-center gap-[5px] p-1.5 bg-transparent border-none cursor-pointer z-[60]"
          ...
          >
            {navLinks.map((link, i) => (
              <motion.a
                ...
                onClick={() => setMobileOpen(false)}
                className="text-2xl font-bold text-slate-200 no-underline uppercase tracking-[0.15em]"
              >
                {link.label}
              </motion.a>
            ))}
